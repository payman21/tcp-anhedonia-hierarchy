function rendersurface_reward_rois(roi_values, rangemin, rangemax, inv, clmap, surfacetype)
% Renders mean hierarchical level values for 4 cortical reward ROIs.
...
%
% Example usage:
%   rendersurface_reward_rois([0.21, 0.17, 0.19, 0.22])
% to run
% data = load('path/to/your_4_roi_values.txt');
% rendersurface_reward_rois(data)
...
% Paint each ROI with its scalar value
for r = 1:4
